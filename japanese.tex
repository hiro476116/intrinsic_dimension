...
\begin{proof}
    ...
    よって, 仮定2.2を用いると, 
    \begin{align}
        \|Y_{t_{n+1}}-\hat{Y}_{t_{n+1}}\|_2
        &\leqq
            e^{h_n}\{1+L(t_n)(1-e^{-2h_n})\}
        \|Y_{t_n}-\hat{Y}_{t_n}\|_2
        \notag\\
        &\quad
        +
        e^{h_n}
        ...
        du .
    \end{align}
    ここで, $e^{-(t_{n+1}-u)}\leqq 1$かつ $\frac{\sigma^2_{T-t_{n+1}}}{\sigma^2_{T-u}}\leqq 1$ であることから, 
    \begin{align}
        &\int_{t_n}^{t_{n+1}}
        e^{-(t_{n+1}-u)}
        \frac{\sigma^2_{T-t_{n+1}}}{\sigma^2_{T-u}}
    ...
    \right\|_2
    du .\\
    &\leqq 4(t_{n+1}-t_n) \int_{t_n}^{t_{n+1}}     
