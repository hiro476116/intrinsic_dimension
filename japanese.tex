...
\begin{proof}
    ...
    である. ここで, 
    \begin{align}
        Y_T-\hat{Y}_{t_N}=Y_0-\hat{Y}_{t_0}+\int_{0}^{T}(1-\frac{2}{\sigma^2_{T-t}})(Y_t-\hat{Y}_t)dt+\int_{0}^{T}\frac{2\sqrt{1-\sigma^2_{T-t}}}{\sigma^2_{T-t}}(\mu_{T-t}(Y_t)-\hat{\mu}_{T-t_n}(\hat{Y}_{t_n}))dt
    \end{align}
    であることから,
    \begin{align}
    ...
    次に, 
    \begin{align}
        \mu_{T-t}(Y_t)-\hat{\mu}_{T-t_n}(\hat{Y}_{t_n})=&\mu_{T-t}(Y_t)-\mu_{T-t_n}(Y_{t_n})+\frac{\sigma^2_{T-t_n}}{\sqrt{1-\sigma^2_{T-t_n}}}(s_{T-t_n}(Y_{t_n})-\hat{s}_{T-t_n}(Y_{t_n}))\\
        &+\frac{1}{\sqrt{1-\sigma^2_{t_n}}}(Y_{t_n}-\hat{Y}_{t_n}+\sigma^2_{T-t_n}(\hat{s}_{T-t_n}(Y_{t_n})-\hat{s}_{T-t_n}(\hat{Y}_{t_n})))
    \end{align}
    となることを用いると, 
    \begin{align}
        &E[\|\int_{0}^{T}\frac{2\sqrt{1-\sigma^2_{T-t}}}{\sigma^2_{T-t}}(\mu_{T-t}(Y_t)-\hat{\mu}_{T-t_n}(\hat{Y}_{t_n}))dt\|^2]^{\frac{1}{2}}\\
        &\leqq E[\|\int_{0}^{T}\frac{2\sqrt{1-\sigma^2_{T-t}}}{\sigma^2_{T-t}}(\mu_{T-t}(Y_t)-\mu_{T-t_n}(Y_{t_n}))dt\|^2]^{\frac{1}{2}}\\
        &+E[\|\int_{0}^{T}(s_{T-t_n}(Y_{t_n})-\hat{s}_{T-t_n}(Y_{t_n}))dt\|^2]^{\frac{1}{2}}\\
        &+E[\|\int_{0}^{T}\frac{2\sqrt{1-\sigma^2_{T-t}}}{\sigma^2_{T-t}}(\hat{\mu}_{T-t_n}(Y_{t_n})-\hat{\mu}_{T-t_n}(\hat{Y}_{t_n}))dt\|^2]^{\frac{1}{2}}
    \end{align}
    と評価できる.
    ここで, 仮定2.2を使って (27) 式は次のように評価できる.
    \begin{align}
        &E[\|\int_{0}^{T}(s_{T-t_n}(Y_{t_n})-\hat{s}_{T-t_n}(Y_{t_n}))dt\|^2]^{\frac{1}{2}}\\
        &\leqq (\sum_{n=0}^{N-1}(t_{n+1}-t_n)\mathbb{E}[\|s_{T-t_n}(X_{T-t_n})-\hat{s}_{T-t_n}(X_{T-t_n})\|^2])^{\frac{1}{2}}\leqq \epsilon
    \end{align}
    次に, (28)式を評価すると, 
    \begin{align}
        &E[\|\int_{0}^{T}\frac{2\sqrt{1-\sigma^2_{T-t}}}{\sigma^2_{T-t}}(\hat{\mu}_{T-t_n}(Y_{t_n})-\hat{\mu}_{T-t_n}(\hat{Y}_{t_n}))dt\|^2]^{\frac{1}{2}}\\
