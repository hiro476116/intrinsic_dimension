...
\[
    \mu_{T-t}(Y_t)=\E\left[X_0\mid\mathcal F_t\right],
\]
the process
...
\[
    X_0-\mu_{T-s}(Y_s)
    =
    \bigl(X_0-\mu_{T-t}(Y_t)\bigr)
    +\bigl(\mu_{T-t}(Y_t)-\mu_{T-s}(Y_s)\bigr).
\]
Moreover, $\mu_{T-t}(Y_t)-\mu_{T-s}(Y_s)$ is
$\mathcal F_t$-measurable and
\[
    \E\left[
        X_0-\mu_{T-t}(Y_t)
        \,\middle|\,
...
\[
    \mu_{T-r}(Y_r)=\E\left[X_0\mid Y_r\right].
\]
...
\begin{split}
    ...
    \E\left[
        \E\left[
            \norm{X_0-\E\left[X_0\mid Y_r\right]}^2
            \,\middle|\,
            Y_r
        \right]
    \right]\\
